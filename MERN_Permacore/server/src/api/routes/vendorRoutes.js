...
router.post('/:id/certifications', vendorController.addCertification);

// PUT to update a certification
router.put('/:vendorId/certifications/:certificationId', vendorController.updateCertification);
